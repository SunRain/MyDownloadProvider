...
package me.android.download.provider;

import me.android.download.providers.downloads.DownloadManager;
...
public final class Downloads {
	...
	public static final class Impl implements BaseColumns {
		 ...
		 */
		public static final String PERMISSION_ACCESS = "me.android.permission.ACCESS_DOWNLOAD_MANAGER";

		/**
		 * The permission to access the download manager's advanced functions
		 */
		public static final String PERMISSION_ACCESS_ADVANCED = "me.android.permission.ACCESS_DOWNLOAD_MANAGER_ADVANCED";

		/**
		 * The permission to access the all the downloads in the manager.
		 */
		public static final String PERMISSION_ACCESS_ALL = "me.android.permission.ACCESS_ALL_DOWNLOADS";

		/**
		 * The permission to directly access the download manager's cache
		 * directory
		 */
		public static final String PERMISSION_CACHE = "me.android.permission.ACCESS_CACHE_FILESYSTEM";

		/**
		 * The permission to send broadcasts on download completion
		 */
		public static final String PERMISSION_SEND_INTENTS = "me.android.permission.SEND_DOWNLOAD_COMPLETED_INTENTS";

		/**
		 * The permission to download files to the cache partition that won't be
		 * automatically purged when space is needed.
		 */
		public static final String PERMISSION_CACHE_NON_PURGEABLE = "me.android.permission.DOWNLOAD_CACHE_NON_PURGEABLE";

		/**
		 * The permission to download files without any system notification
		 * being shown.
		 */
		public static final String PERMISSION_NO_NOTIFICATION = "me.android.permission.DOWNLOAD_WITHOUT_NOTIFICATION";
